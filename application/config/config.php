...
*/
// local dev
$config['base_url'] = 'http://localhost:9090/quesys-skutrexindo/';
// live dev
// $config['base_url'] = 'https://live.akira.id/quesys-skutrexindo/';
// prod
// $config['base_url'] = 'https://antrian.skutrexindo.com/';
